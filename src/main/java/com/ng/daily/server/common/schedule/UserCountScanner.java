 ...
 ********/
package com.ng.daily.server.common.schedule;
...
public class UserCountScanner {
	...
	private static final Logger logger = LoggerFactory.getLogger(UserCountScanner.class);
...
//		long userCount = accountService.getUserCount();
		logger.info("There are {} user in database.", System.currentTimeMillis());
	}
}
