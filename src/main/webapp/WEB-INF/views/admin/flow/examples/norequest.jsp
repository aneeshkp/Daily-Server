...
<div id="header">
    <div class="lattern"><a href="../example-operate/delete.jsp">demo-del</a><a href="../example-operate/order.jsp">demo-order</a><a
            class="redlk" href="recycledemo1.jsp" title="auto recycle">demo-recycle</a><a class="redlk"
                                                                                          href="messup.jsp"
                                                                                          title="messup">demo-messup</a><a
            class="redlk" href="reinstall.jsp" title="messup">demo-reinstall</a><a href="mobile.jsp">demo-mobile</a><a
            href="fixedw.jsp" title="fixed width">demo-fixedw</a><a href="../examples/norequest.jsp">demo-simplest</a><a
            href="specialcol.jsp">demo-specialcol</a><a href="main.jsp">demo-main</a><a
            href="sinkleft.jsp">demo-sink</a><a href="http://blog.duitang.com/?p=1" target="_blank">博客</a><a
            href="https://github.com/duitang/waterfall" target="_blank">GitHub</a></div>
...
<div id="content">
    ...
    <div class="newinfo">
        Only first subpage without any other data request. <br/>
        简化版，无分页请求，只需把第一页内容放在 woo-pcont 节点里即可，css js 依赖大大减少，也不需要额外提供后端接口。
    </div>
    <div id="woo-holder">
