...
<div id="content">
    ...
    <div class="newinfo">
        Several approaches to build Waterfall with fixed width. <br/>
        1. Give a width value to node '#woo-holder' or its parentNode. <br/>
        2. Give a data-domwidth="460" to node '.woo-pcont' if you want to make a Waterfall different from others, as the
        demo has shown you by clicking 'my fav'.
    </div>
    <div id="woo-holder">
        ...
        <div class="woo-swb">
            ...
            <div class="woo-pcont woo-masned my-album" data-domwidth="460" data-wootemp="1" data-subpagenum="6"></div>
            <div class="woo-pager"></div>
        </div>
    </div>
    <!-- Woo holder over -->
