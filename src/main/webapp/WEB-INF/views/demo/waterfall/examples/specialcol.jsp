...
<head>
    ...
    <!-- special column -->
    <link rel="stylesheet" href="${ctx}/static/libs/waterfall/css/specialcol.css"/>
...
<div id="content">
    <div id="woo-holder">
        ...
        <a name="woo-anchor"></a>
        <ul id="switchholder">
            <li class="woo-swa"><a href="javascript:;">my pics</a></li>
            <li class="woo-swa"><a href="javascript:;">my fav</a></li>
            <li class="woo-swa"><a href="javascript:;">my albums</a></li>
            <li class="woo-swa woo-cur"><a href="javascript:;">my collects</a></li>
        </ul>


        <div class="woo-swb">
            <div class="woo-pcont woo-masned my-pic" data-sink="#mytags" data-sinkheight="100">
        ...
        <div class="woo-swb">
            ...
            <div class="woo-pcont woo-masned my-album" data-domwidth="1000" data-wootemp="1" data-subpagenum="6"
                 data-sink="#mytags" data-sinkheight="140"></div>
            <div class="woo-pager"></div>
        </div>
        <div class="woo-swb">
        ...
        <div class="woo-swb">
            <div class="woo-pcont woo-masned my-pic" data-sink="#mytags" data-sinkheight="140" data-sinkright="1"></div>
            <div class="woo-pager"></div>
        </div>
...
<script>
    $(function () {
        ...
        var conf = {
            ...
            "arrfmasnw": [100, 40, 0, 100],

            // The gap between units in one column.
            "arrgap": 4,


            // If you open it, units in one appending procedure will be seperated into smaller batchs.
            // For example, at first, we append 12(appendnum=12) units at a time.
            // Now, we open it and set batchdelay=10 and batchnum=2.
            // Then, each time we append only 2 units with a delay of 10ms
            // Maybe it's not usefull, maybe you'd like to have a try.
            "batchopen": true,
